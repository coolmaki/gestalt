...
public static class ResultExtensions
{
    ...
    {
        ErrorType.Validation => "https://errors.gestalt.dev/validation",
        ErrorType.NotFound => "https://errors.gestalt.dev/not-found",
        ErrorType.Conflict => "https://errors.gestalt.dev/conflict",
        ErrorType.Unauthorized => "https://errors.gestalt.dev/unauthorized",
        ErrorType.Unexpected => "https://errors.gestalt.dev/unexpected",
        _ => "about:blank",
    };
