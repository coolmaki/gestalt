...
| TD-004 | 🔴 High | Frontend | shared | `web/@supercluster/core/` not yet scaffolded. Design tokens, components, PWA, auth, nav, and i18n need to exist before any app frontend is built. See `shared-core-scaffold.md` plan. | 2026-06-27 |
