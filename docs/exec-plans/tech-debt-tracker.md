...
| TD-004 | ✅ Resolved | Frontend | shared | `@supercluster/core` scaffolded with pnpm workspace, design tokens, 4-theme system, 7 components, PWA, and auth plans. | 2026-06-27 |
